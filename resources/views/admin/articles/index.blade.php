        ...
        <div class="container-wide">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <a href="{{ route('admin.articles.create') }}"
                    class="btn-corporate bg-mcc-gold text-mcc-slate-900 hover:bg-white">
                        ...
                        <tbody class="divide-y divide-mcc-slate-100">
                            @forelse($articles as $article)
                                <tr class="hover:bg-mcc-blue-50/30 transition-colors">
                                    <td class="px-8 py-5">
                                        <div
                                            class="w-20 h-12 rounded-lg bg-mcc-slate-100 overflow-hidden border border-mcc-slate-200">
                                    ...
                                    <td class="px-8 py-5">
                                        <span
                                            class="text-sm text-mcc-slate-600">{{ $article->published_at->format('M d, Y') }}</span>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-8 py-12 text-center text-mcc-slate-400 italic">No articles found.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
