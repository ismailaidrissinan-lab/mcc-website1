    ...
    <div class="relative pt-32 pb-48 lg:pb-64 bg-mcc-slate-900 overflow-hidden">
        ...
        <div class="container-wide relative z-10 text-center">
            <div
                ...
                <span
                    class="text-mcc-gold text-[10px] font-bold uppercase tracking-widest">{{ __('Global Citizenship') }}</span>
            </div>
    ...
    <section class="-mt-32 relative z-20 pb-32">
        <div class="container-wide">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <div class="group flex flex-col bg-white rounded-3xl overflow-hidden border border-mcc-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500"
                        ...
                        <div class="p-8 flex-grow flex flex-col text-left">
                            <a href="{{ route('csr.show', $project->slug) }}" class="group/title">
                                <h4
                                    class="text-xl font-bold text-mcc-slate-900 mb-4 group-hover/title:text-mcc-blue-600 transition-colors">
                                    {{ $project->title }}</h4>
                            </a>
                            ...
                            <div class="mt-auto pt-6 border-t border-mcc-slate-50">
                                <a href="{{ route('csr.show', $project->slug) }}"
                ...
                @empty
                    <div
                        class="col-span-full bg-white p-12 md:p-20 rounded-[3rem] shadow-2xl border border-mcc-slate-100 text-center">
                        <div class="max-w-3xl mx-auto space-y-8">
                            <h2 class="text-3xl font-bold text-mcc-slate-900">{{ __('Our Commitment to Shared Prosperity') }}
                            </h2>
