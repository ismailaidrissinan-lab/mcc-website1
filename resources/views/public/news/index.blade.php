    ...
    <div class="relative pt-32 pb-24 bg-mcc-slate-900 overflow-hidden">
        <div class="absolute inset-0 opacity-40">
            <img src="{{ asset('images/mcc-logo.png') }}"
                alt="Chinese Architecture" class="w-full h-full object-cover">
        </div>
        <div class="container-wide relative z-10 text-center">
            <div
                ...
                <span
                    class="text-mcc-gold text-[10px] font-bold uppercase tracking-widest">{{ __('Corporate Intelligence') }}</span>
            </div>
