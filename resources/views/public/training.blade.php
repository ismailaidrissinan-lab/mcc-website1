...
<div class="relative pt-32 pb-20 bg-mcc-slate-900 overflow-hidden">
    <div class="absolute inset-0 opacity-30">
        <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=2000&q=80" class="w-full h-full object-cover">
    </div>
    <div class="container-wide relative z-10">
        <div class="inline-flex items-center space-x-2 px-3 py-1 bg-mcc-gold/20 border border-mcc-gold/30 rounded-full mb-6">
            <span class="text-mcc-gold text-[10px] font-bold uppercase tracking-widest">{{ __('Internal Investment') }}</span>
        </div>
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
            <div class="space-y-8" reveal>
                ...
                <div class="grid grid-cols-2 gap-8 pt-6">
                    <div class="p-6 bg-mcc-slate-50 rounded-2xl border border-mcc-slate-100">
                        ...
                        <div class="text-xs font-bold text-mcc-gold uppercase tracking-widest">{{ __('Local Workforce') }}</div>
                    </div>
                    <div class="p-6 bg-mcc-slate-50 rounded-2xl border border-mcc-slate-100">
                        <div class="text-4xl font-bold text-mcc-blue-600 mb-1">2,000+</div>
                        <div class="text-xs font-bold text-mcc-gold uppercase tracking-widest">{{ __('Alumni Engineers') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-16 lg:mt-0 relative" reveal>
                <div class="aspect-[4/5] bg-mcc-slate-100 rounded-[3rem] overflow-hidden shadow-2xl relative z-10">
                    <img src="https://images.unsplash.com/photo-1544725121-be3b5d0c0dc5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" alt="Training Session" class="w-full h-full object-cover">
                </div>
...
<section class="section-padding bg-mcc-slate-900 text-white overflow-hidden">
    <div class="container-wide">
        <div class="text-center max-w-3xl mx-auto mb-20" reveal>
            <h2 class="text-mcc-gold font-bold text-xs uppercase tracking-[0.2em] mb-4">{{ __('Development Portfolio') }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="group relative bg-white/5 backdrop-blur-md rounded-[2.5rem] p-10 border border-white/10 transition-all duration-500 hover:bg-white/10" reveal>
                <div class="flex flex-col h-full justify-between">
                    <div>
                        <div class="inline-flex items-center space-x-2 px-3 py-1 bg-mcc-gold/20 border border-mcc-gold/30 rounded-full mb-8">
                            <span class="text-mcc-gold text-[10px] font-bold uppercase tracking-widest">{{ $program->location }}</span>
                        </div>
                        <h4 class="text-2xl font-bold mb-4 group-hover:text-mcc-gold transition-colors">{{ $program->title }}</h4>
...
<section class="py-24 bg-white">
    <div class="container-wide">
        <div class="lg:grid lg:grid-cols-2 lg:gap-20 items-center bg-mcc-slate-50 rounded-[4rem] p-12 md:p-20 shadow-xl overflow-hidden relative">
            ...
            <div class="relative z-10" reveal>
                ...
                <a href="{{ route('contact') }}" class="btn-corporate bg-mcc-blue-900 text-white hover:bg-mcc-blue-950 justify-center">
                    {{ __('Explore Careers & Training') }}
                </a>
            </div>
            
            <div class="mt-16 lg:mt-0 relative z-10" reveal>
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" alt="Team Work" class="rounded-3xl shadow-lg w-full">
            </div>
        </div>
    </div>
</section>
