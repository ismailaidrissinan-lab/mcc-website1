    ...
    <div class="relative pt-32 pb-20 bg-mcc-slate-900 overflow-hidden">
        <div class="absolute inset-0 opacity-40">
            <img src="{{ asset('images/mcc-logo.png') }}"
                alt="The Great Wall of China" class="w-full h-full object-cover">
        </div>
        <div class="container-wide relative z-10 text-center">
            <div
                ...
                <span
                    class="text-mcc-gold text-[10px] font-bold uppercase tracking-widest">{{ __('Corporate Profile') }}</span>
            </div>
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
                <div class="relative">
                    <div class="aspect-square bg-mcc-slate-100 rounded-[3rem] overflow-hidden shadow-2xl relative z-10">
                        <img src="{{ asset('images/mcc-logo.png') }}"
                            alt="Executive Meeting" class="w-full h-full object-cover">
                    </div>
                    <!-- Decorative Elements -->
                ...
                <div class="space-y-16">
                    ...
                    <div class="relative flex flex-col md:flex-row items-center">
                        <div class="flex-1 md:text-right md:pr-12 mb-4 md:mb-0">
                            ...
                            <p class="text-mcc-slate-500 text-sm italic">
                                {{ __('Establishment of MCC with a focus on international engineering cooperation.') }}</p>
                        </div>
                        <div
                            class="w-4 h-4 rounded-full bg-mcc-blue-600 border-4 border-white shadow-lg relative z-10 hidden md:block">
                        </div>
                    ...
                    <div class="relative flex flex-col md:flex-row items-center">
                        ...
                        <div class="flex-1 md:pl-12">
                            ...
                            <p class="text-mcc-slate-500 text-sm italic">
                                {{ __('Major project launches in transport and energy sectors across Nigeria and West Africa.') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative flex flex-col md:flex-row items-center">
                        <div class="flex-1 md:text-right md:pr-12 mb-4 md:mb-0">
                            ...
                            <p class="text-mcc-slate-500 text-sm italic">
                                {{ __('Focus shift towards renewable energy and smart city infrastructure.') }}</p>
                        </div>
                        <div
                            class="w-4 h-4 rounded-full bg-mcc-blue-600 border-4 border-white shadow-lg relative z-10 hidden md:block">
                        </div>
        ...
        <div class="container-wide">
            <div class="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
                <div class="space-y-8" reveal>
                    ...
                    <div class="grid grid-cols-2 gap-8 pt-4">
                        <div class="space-y-2">
                            ...
                            <div class="text-xs text-mcc-gold uppercase tracking-widest font-bold">{{ __('Countries') }}
                            </div>
                        </div>
                        <div class="space-y-2">
                            <div class="text-3xl font-bold text-white">4</div>
                            <div class="text-xs text-mcc-gold uppercase tracking-widest font-bold">{{ __('Regional Hubs') }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mt-16 lg:mt-0 relative group">
                    <div
                        class="bg-white/5 p-4 rounded-[3rem] backdrop-blur-sm border border-white/10 overflow-hidden transform transition-transform duration-500 group-hover:scale-[1.02]">
                        <img src="{{ asset('images/mcc-logo.png') }}"
                            alt="Global Presence Map" class="w-full h-auto rounded-[2.2rem]">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding bg-white">
        <div class="container-wide">
            <div class="flex flex-col lg:flex-row items-center justify-between mb-20 gap-10" reveal>
                <div class="max-w-2xl">
                    <h2 class="text-mcc-gold font-bold text-xs uppercase tracking-[0.2em] mb-4">{{ __('Responsibility') }}
                    </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div
                    class="p-10 bg-mcc-slate-50 rounded-3xl border border-mcc-slate-100 transition-all duration-300 hover:shadow-xl group">
                    <div
                        class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-mcc-blue-600 mb-8 shadow-sm group-hover:bg-mcc-blue-600 group-hover:text-white transition-colors duration-500">
                    ...
                    <p class="text-mcc-slate-500 text-sm leading-relaxed">
                        {{ __('Empowering the next generation through engineering scholarships and facility upgrades.') }}
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-mcc-slate-500 text-sm leading-relaxed">
                        {{ __('Investing in community clinics and localized medical supplies to build resilient health systems.') }}
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-mcc-slate-500 text-sm leading-relaxed">
                        {{ __('Focusing on 85%+ local workforce participation in our projects to drive regional economic stability.') }}
                    </p>
                </div>
            </div>
        </div>
